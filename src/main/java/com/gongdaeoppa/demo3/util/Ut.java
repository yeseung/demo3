package com.gongdaeoppa.demo3.util;
...
public class Ut {
	...
	public static String jsReplace(String msg, String uri) {
        ...
        sb.append("alert(msg);");
        sb.append("}");
        sb.append("location.replace('%s');");
        sb.append("</script>");
        //return sb.toString();
        
        return Ut.f(sb.toString(), msg, uri);
        
		//return Ut.f("%s / %s", msg, uri);
	}
